...
//Ende
define('MODULE_PAYMENT_INVOICE_TEXT_TITLE', 'Απόδειξη/Τιμολόγιο (Πληρωτέο έως '. $tag . ')');
define('MODULE_PAYMENT_INVOICE_TEXT_DESCRIPTION', '');

define('MODULE_PAYMENT_INVOICE_TEXT_EMAIL_FOOTER', 
"Παρακαλούμε χρησιμοποιήστε τις παρακάτω πληροφορίες για να μεταφέρετε το συνολικό ποσό της αξίας της παραγγελίας σας.:\n" .
"\nΤράπεζα:  " . MODULE_PAYMENT_INVOICE_BANKNAM .
"\nΚάτοχος Λογαριασμού: " . MODULE_PAYMENT_INVOICE_ACCNAM . 
