...
define('OTHER_BOX_NOTIFY_REMOVE_ALT', 'Αφαίρεση αυτής της ειδοποίησης προϊόντος.');
define('OTHER_BOX_NOTIFY_YES_ALT', 'Ειδοποίησε με σχετικά με αλλαγές σε αυτό το προϊόν.');
define('OTHER_BOX_WRITE_REVIEW_ALT', 'Γράψε μια κριτική για αυτό το προϊόν.');
define('OTHER_CALL_FOR_PRICE_ALT', 'Παρακαλούμε τηλεφωνήστε για την τρέχουσα τιμή.');
define('OTHER_DOWN_FOR_MAINTENANCE_ALT', 'Ο ιστοχώρος βρίσκεται υπό συντήρηση. Παρακαλούμε ελάτε αργότερα');
define('OTHER_TRANPARENT_ALT', '');
define('OTHER_IMAGE_CUSTOMERS_AUTHORIZATION_ALT', 'ΑΝΑΜΕΝΕΤΑΙ ΑΠΟΔΟΧΗ ΑΠΟ ΤΟΝ ΠΕΛΑΤΗ ...');
define('OTHER_REVIEWS_RATING_STARS_FIVE_ALT', 'Πέντε Αστέρια');
define('OTHER_REVIEWS_RATING_STARS_FOUR_ALT', 'Τέσσερα Αστέρια');
define('OTHER_REVIEWS_RATING_STARS_THREE_ALT', 'Τρία Αστέρια');
define('OTHER_REVIEWS_RATING_STARS_TWO_ALT', 'Δύο Αστέρια');
define('OTHER_REVIEWS_RATING_STARS_ONE_ALT', 'Ένα Αστέρι');
