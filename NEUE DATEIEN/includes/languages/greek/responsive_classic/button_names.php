...
define('BUTTON_CREATE_ACCOUNT_ALT', 'Εγγραφή');
define('BUTTON_LOG_OFF_ALT', 'Έξοδος');
define('BUTTON_ADD_TO_CART_ALT', 'Στο καλάθι μου');
define('BUTTON_ADD_ADDRESS_ALT', 'Προσθήκη διεύθυνσης');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','Προσθήκη επιλεγμένων στο καλάθι');
define('BUTTON_BACK_ALT', 'Πίσω');
define('BUTTON_BUY_NOW_ALT', 'Αγορά');
define('BUTTON_CANCEL_ALT', 'Άκυρο');
define('BUTTON_CHANGE_ADDRESS_ALT', 'Αλλαγή διεύθυνσης');
define('BUTTON_CHECKOUT_ALT', 'Ταμείο');
define('BUTTON_CONFIRM_SEND_ALT', 'Αποστολή κουπονιού δώρου');
define('BUTTON_CONFIRM_ORDER_ALT', 'Επιβεβαίωση παραγγελίας ');
define('BUTTON_CONTINUE_ALT', 'Συνέχεια');
define('BUTTON_CONTINUE_SHOPPING_ALT', 'Συνέχεια αγορών');
define('BUTTON_DELETE_ALT', 'Διαγραφή');
define('BUTTON_DELETE_SMALL_ALT', 'Διαγραφή');
define('BUTTON_DOWNLOAD_ALT', 'Κατέβασμα τώρα');
define('BUTTON_EDIT_SMALL_ALT', 'Επεξεργασία');
define('BUTTON_IN_CART_ALT', 'Στο καλάθι');
define('BUTTON_LOGIN_ALT', 'Είσοδος');
define('BUTTON_NEXT_ALT', 'Επόμενο');
define('BUTTON_PREVIOUS_ALT', 'Προηγούμενο');
define('BUTTON_REDEEM_ALT', 'Εξαργύρωση');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Επιστροφή στη λίστα προϊόντων');
define('BUTTON_REVIEWS_ALT', 'Ανάγνωση σχολίων');
define('BUTTON_SEARCH_ALT', 'Αναζήτηση');
define('BUTTON_SEND_ALT', 'Αποστολή τώρα');
define('BUTTON_SEND_ANOTHER_ALT', 'Στείλε ένα άλλη μία Δωροεπιταγή');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Στείλε μία Δωροεπιταγή');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Εκτιμητής αποστολής');
define('BUTTON_SOLD_OUT_ALT', 'Εξαντλήθηκε');
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Εξαντλήθηκε');
define('BUTTON_SUBMIT_ALT', 'Αποστολή');
define('BUTTON_UNSUBSCRIBE', 'Απεγγραφή');
define('BUTTON_UPDATE_ALT', 'Ανανέωση');
define('BUTTON_VIEW_SMALL_ALT', 'Προβολή');
define('BUTTON_WRITE_REVIEW_ALT', 'Εγγραφή σχολίου');
define('BUTTON_READ_REVIEWS_ALT', 'Ανάγνωση σχολίου');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Λεπτομέρειες προϊόντος');
define('BUTTON_MORE_REVIEWS_ALT', 'Ανάγνωση περισσότερων σχολίων');
