...
define('ICON_ERROR_ALT', 'Λάθος');
define('ICON_SUCCESS_ALT', 'Επιτυχία');
define('ICON_WARNING_ALT', 'Προειδοποίηση');
define('ICON_TRASH_ALT', 'Διαγραφή');
define('ICON_UPDATE_ALT', 'Ανανέωση');
define('ICON_TINYCART_ALT', 'Προσθήκη στο καλάθι');
